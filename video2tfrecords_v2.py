...
FLAGS = flags.FLAGS
flags.DEFINE_integer('num_videos', 10, 'Number of videos stored in one single tfrecords file')
...
flags.DEFINE_boolean('optical_flow', False, 'Indictes whether optical flow shall be computed and added as fourth '
